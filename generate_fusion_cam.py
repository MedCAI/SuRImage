...
from models import CoarseNet, FineNet, Fusion, Post
...
if __name__ == "__main__":
    ...
    weight3_path = '/data2/ceiling/workspace/RCFNet/save_model/ROI_404_Fusion_RCFNet_5cls_20240121/fusion_epoch_1.pth'
    model = Post(weight1_path, weight2_path, weight3_path)
    model.eval()
    
    save_dir = '/data2/ceiling/workspace/RCFNet/attentionmaps/ROI_combined_404/fusion_coarse/test/'
