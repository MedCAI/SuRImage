...
if __name__ == "__main__":
    ...
    save_path = '/data2/ceiling/workspace/RCFNet/save_model/ROI_303_Fusion_clinic_RCFNet_5cls_20240206/ROC_clinic_{}.png'.format('fine')
    ...
    save_prob = '/data2/ceiling/workspace/RCFNet/save_model/ROI_303_Fusion_clinic_RCFNet_5cls_20240206/prob_clinic_{}.csv'.format('fine')
