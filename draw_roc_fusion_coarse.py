...
if __name__ == "__main__":
    ...
    """
    weight1_path = '/data2/ceiling/workspace/RCFNet/save_model/ROI_505_RCFNet_5cls_20240121/net1_epoch_35.pth'
    weight2_path = '/data2/ceiling/workspace/RCFNet/save_model/ROI_505_RCFNet_5cls_20240121/net2_epoch_35.pth'
    weight_model_path = '/data2/ceiling/workspace/RCFNet/save_model/ROI_505_Fusion_RCFNet_5cls_20240121/fusion_epoch_2.pth'
    save_path = '/data2/ceiling/workspace/RCFNet/save_model/ROI_505_Fusion_RCFNet_5cls_20240121/ROC_fusion_{}.png'.format('coarse')
    ...
    save_prob = '/data2/ceiling/workspace/RCFNet/save_model/ROI_505_Fusion_RCFNet_5cls_20240121/prob_fusion_{}.csv'.format('coarse')
    method = 'weighted'
